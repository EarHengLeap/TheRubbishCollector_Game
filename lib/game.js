...
function showWin() {
    // Display a "You Win" message or screen
    var winText = game.add.text(game.camera.view.centerX, game.camera.view.centerY, 'You Win!', { font: '48px Arial', fill: '#00FF00' });
    winText.anchor.setTo(0.5);
    winText.fixedToCamera = true;

    // Stop the player's movement and animations
    player.body.velocity.x = 0;
    player.animations.stop();
}